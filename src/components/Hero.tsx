    ...
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            ...
            <p className="text-white/80 text-xl font-sans mb-10 max-w-xl leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-secondary hover:bg-accent text-primary px-10 py-4 rounded-full font-bold text-lg shadow-xl transition-all"
              >
                Join Us This Sunday
              </motion.button>
              <motion.button
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center">
        <motion.div
          ...
          className="w-1 h-12 bg-gradient-to-b from-white/60 to-transparent rounded-full"
        />
      </div>
    </section>
  );
